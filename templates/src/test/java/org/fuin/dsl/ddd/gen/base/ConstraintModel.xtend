...
class ConstraintModel {
    ...
    /**
     * Returns the model text: the built-in constraints of "org.fuin.constr" plus a module of its own that
     * declares three constraints and uses all of them. It joins the same "org.fuin" context, so the
     * built-in types and constraints are visible without anything to declare.
     *
