 ...
 * </p>
 * <ul>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.AggregateIdImpl#getAggregate <em>Aggregate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregateIdImpl extends AbstractEntityIdImpl implements AggregateId
{
  ...
  {
    return CqrsDslPackage.Literals.AGGREGATE_ID;
  }
    ...
    if (aggregate != null && aggregate.eIsProxy())
    {
      ...
      if (aggregate != oldAggregate)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CqrsDslPackage.AGGREGATE_ID__AGGREGATE, oldAggregate, aggregate));
      }
    }
    return aggregate;
  }
  ...
  public void setAggregate(Aggregate newAggregate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.AGGREGATE_ID__AGGREGATE, oldAggregate, aggregate));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CqrsDslPackage.AGGREGATE_ID__AGGREGATE:
