 ...
 * </p>
 * <ul>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.WeakConsistencyImpl#getAcceptableDoc <em>Acceptable Doc</em>}</li>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.WeakConsistencyImpl#getAcceptable <em>Acceptable</em>}</li>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.WeakConsistencyImpl#getDetectionDoc <em>Detection Doc</em>}</li>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.WeakConsistencyImpl#getDetection <em>Detection</em>}</li>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.WeakConsistencyImpl#getResolutionDoc <em>Resolution Doc</em>}</li>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.WeakConsistencyImpl#getResolution <em>Resolution</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WeakConsistencyImpl extends MinimalEObjectImpl.Container implements WeakConsistency
{
  ...
  {
    return CqrsDslPackage.Literals.WEAK_CONSISTENCY;
  }
  ...
  public void setAcceptableDoc(String newAcceptableDoc)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.WEAK_CONSISTENCY__ACCEPTABLE_DOC, oldAcceptableDoc, acceptableDoc));
  }
  ...
  public NotificationChain basicSetAcceptable(Duration newAcceptable, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CqrsDslPackage.WEAK_CONSISTENCY__ACCEPTABLE, oldAcceptable, newAcceptable);
  ...
  public void setAcceptable(Duration newAcceptable)
  {
    if (newAcceptable != acceptable)
    {
      ...
      if (acceptable != null)
        msgs = ((InternalEObject)acceptable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CqrsDslPackage.WEAK_CONSISTENCY__ACCEPTABLE, null, msgs);
      if (newAcceptable != null)
        msgs = ((InternalEObject)newAcceptable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CqrsDslPackage.WEAK_CONSISTENCY__ACCEPTABLE, null, msgs);
      msgs = basicSetAcceptable(newAcceptable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.WEAK_CONSISTENCY__ACCEPTABLE, newAcceptable, newAcceptable));
  }
  ...
  public void setDetectionDoc(String newDetectionDoc)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.WEAK_CONSISTENCY__DETECTION_DOC, oldDetectionDoc, detectionDoc));
  }
  ...
  public void setDetection(InconsistencyDetection newDetection)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.WEAK_CONSISTENCY__DETECTION, oldDetection, detection));
  }
  ...
  public void setResolutionDoc(String newResolutionDoc)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.WEAK_CONSISTENCY__RESOLUTION_DOC, oldResolutionDoc, resolutionDoc));
  }
  ...
  public void setResolution(InconsistencyResolution newResolution)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.WEAK_CONSISTENCY__RESOLUTION, oldResolution, resolution));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CqrsDslPackage.WEAK_CONSISTENCY__ACCEPTABLE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CqrsDslPackage.WEAK_CONSISTENCY__ACCEPTABLE_DOC:
        return getAcceptableDoc();
      case CqrsDslPackage.WEAK_CONSISTENCY__ACCEPTABLE:
        return getAcceptable();
      case CqrsDslPackage.WEAK_CONSISTENCY__DETECTION_DOC:
        return getDetectionDoc();
      case CqrsDslPackage.WEAK_CONSISTENCY__DETECTION:
        return getDetection();
      case CqrsDslPackage.WEAK_CONSISTENCY__RESOLUTION_DOC:
        return getResolutionDoc();
      case CqrsDslPackage.WEAK_CONSISTENCY__RESOLUTION:
