 ...
 * enclosing project.
 */
class CqrsDslQualifiedNameProvider extends DefaultDeclarativeQualifiedNameProvider {
	 ...
	 */
	override protected QualifiedName computeFullyQualifiedName(EObject obj) {
