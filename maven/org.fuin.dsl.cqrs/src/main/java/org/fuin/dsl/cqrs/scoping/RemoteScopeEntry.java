...
public final class RemoteScopeEntry {
    ...
    /**
     * A canonical identity for the source, used to remember what was resolved for the session.
     * Returns <code>null</code> for an unknown type.
     */
    public String getSourceId() {
        if (TYPE_MAVEN.equals(type)) {
            return "mvn:" + groupId + ":" + artifactId + ":" + version + ":"
                    + CqrsArtifactResolver.EXTENSION;
        }
        return null;
    }
