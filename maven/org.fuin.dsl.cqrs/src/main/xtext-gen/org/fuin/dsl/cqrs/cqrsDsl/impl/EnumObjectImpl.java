 ...
 * </p>
 * <ul>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.EnumObjectImpl#getBase <em>Base</em>}</li>
 *   <li>{@link org.fuin.dsl.cqrs.cqrsDsl.impl.EnumObjectImpl#getInstances <em>Instances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumObjectImpl extends InternalTypeImpl implements EnumObject
{
  ...
  {
    return CqrsDslPackage.Literals.ENUM_OBJECT;
  }
    ...
    if (base != null && base.eIsProxy())
    {
      ...
      if (base != oldBase)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CqrsDslPackage.ENUM_OBJECT__BASE, oldBase, base));
      }
    }
    return base;
  }
  ...
  public void setBase(ExternalType newBase)
  {
    ...
    base = newBase;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.ENUM_OBJECT__BASE, oldBase, base));
  }
  ...
  public EList<EnumInstance> getInstances()
  {
    if (instances == null)
    {
      instances = new EObjectContainmentEList<EnumInstance>(EnumInstance.class, this, CqrsDslPackage.ENUM_OBJECT__INSTANCES);
    }
    return instances;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CqrsDslPackage.ENUM_OBJECT__INSTANCES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CqrsDslPackage.ENUM_OBJECT__BASE:
