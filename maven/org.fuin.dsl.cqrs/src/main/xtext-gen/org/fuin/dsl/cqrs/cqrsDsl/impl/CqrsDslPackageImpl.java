...
public class CqrsDslPackageImpl extends EPackageImpl implements CqrsDslPackage
{
  ...
  public static CqrsDslPackage init()
  {
    ...
    Object registeredCqrsDslPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    CqrsDslPackageImpl theCqrsDslPackage = registeredCqrsDslPackage instanceof CqrsDslPackageImpl ? (CqrsDslPackageImpl)registeredCqrsDslPackage : new CqrsDslPackageImpl();
   ...
   */
  @Override
  public EReference getContext_Hints()
  {
   ...
   */
  @Override
  public EReference getContext_Modules()
  {
   ...
   */
  @Override
  public EAttribute getDependency_Coordinate()
  {
   ...
   */
  @Override
  public EAttribute getDependency_Local()
  {
   ...
   */
  @Override
  public EAttribute getBusinessRule_Doc()
  {
   ...
   */
  @Override
  public EReference getEvent_Origin()
  {
   ...
   */
  @Override
  public EAttribute getMethod_RestPath()
  {
   ...
   */
  @Override
  public EAttribute getVariable_Optional()
  {
   ...
   */
  @Override
  public EReference getBusinessRules_BusinessRuleInstances()
  {
   ...
   */
  @Override
  public EClass getBusinessRuleInstance()
  {
    return businessRuleInstanceEClass;
  }
   ...
   */
  @Override
  public EReference getBusinessRuleInstance_BusinessRule()
  {
    return (EReference)businessRuleInstanceEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getAnnotationInstance_Params()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(contextEClass, CONTEXT__HINTS);
    createEReference(contextEClass, CONTEXT__MODULES);
    ...
    createEAttribute(dependencyEClass, DEPENDENCY__COORDINATE);
    createEAttribute(dependencyEClass, DEPENDENCY__LOCAL);
    ...
    createEReference(eventEClass, EVENT__ORIGIN);
    ...
    createEAttribute(variableEClass, VARIABLE__OPTIONAL);
    ...
    createEReference(businessRulesEClass, BUSINESS_RULES__BUSINESS_RULE_INSTANCES);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getContext_Dependencies(), this.getDependency(), null, "dependencies", null, 0, -1, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getContext_Hints(), this.getHint(), null, "hints", null, 0, -1, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getContext_Modules(), this.getModule(), null, "modules", null, 0, -1, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getDependency_Coordinate(), ecorePackage.getEString(), "coordinate", null, 0, 1, Dependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getDependency_Local(), ecorePackage.getEString(), "local", null, 0, 1, Dependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getEvent_Origin(), this.getAbstractMethod(), null, "origin", null, 0, 1, Event.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getVariable_Optional(), ecorePackage.getEString(), "optional", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getBusinessRules_BusinessRuleInstances(), this.getBusinessRuleInstance(), null, "businessRuleInstances", null, 0, -1, BusinessRules.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getCommandHandler_Aggregates(), this.getAggregate(), null, "aggregates", null, 0, -1, CommandHandler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(projectionEClass, Projection.class, "Projection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getProjection_Events(), this.getEvent(), null, "events", null, 0, -1, Projection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
