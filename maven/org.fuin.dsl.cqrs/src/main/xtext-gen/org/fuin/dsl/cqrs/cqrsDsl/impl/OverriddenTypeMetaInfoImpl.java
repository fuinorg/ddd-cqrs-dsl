...
public class OverriddenTypeMetaInfoImpl extends MinimalEObjectImpl.Container implements OverriddenTypeMetaInfo
{
  ...
  {
    return CqrsDslPackage.Literals.OVERRIDDEN_TYPE_META_INFO;
  }
  ...
  public NotificationChain basicSetMetaInfo(TypeMetaInfo newMetaInfo, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CqrsDslPackage.OVERRIDDEN_TYPE_META_INFO__META_INFO, oldMetaInfo, newMetaInfo);
  ...
  public void setMetaInfo(TypeMetaInfo newMetaInfo)
  {
    if (newMetaInfo != metaInfo)
    {
      ...
      if (metaInfo != null)
        msgs = ((InternalEObject)metaInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CqrsDslPackage.OVERRIDDEN_TYPE_META_INFO__META_INFO, null, msgs);
      if (newMetaInfo != null)
        msgs = ((InternalEObject)newMetaInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CqrsDslPackage.OVERRIDDEN_TYPE_META_INFO__META_INFO, null, msgs);
      msgs = basicSetMetaInfo(newMetaInfo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CqrsDslPackage.OVERRIDDEN_TYPE_META_INFO__META_INFO, newMetaInfo, newMetaInfo));
  }
